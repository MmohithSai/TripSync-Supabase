...
class WeeklySummaryRepository {
  ...
  WeeklySummaryRepository(this._firestore);
  ...
  WeeklySummary _calculateWeeklySummary(
    ...
    final topDestinations = destinationMap.values
...
final weeklySummaryRepositoryProvider = Provider<WeeklySummaryRepository>((ref) {
  return WeeklySummaryRepository(FirebaseFirestore.instance);
});
